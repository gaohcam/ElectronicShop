...
namespace ElectronicShop_Data.Migrations
{
    ...
    [Migration("20230324053712_ProductTable_AddStockField")]
    partial class ProductTable_AddStockField
    {
            ...
            modelBuilder.Entity("ElectronicShop_Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7ce04ac6-f739-40dd-acc0-f82ff531e3ff",
            ...
            modelBuilder.Entity("ElectronicShop_Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "4e75024b-4e6a-4973-99f0-ae6f3236b72b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEc015qrAlqsMb9PtB1/YNuTgRM4aCJNWjbPMlNMzHAFGvKBX0XFy+yOtwtLDCxAxw==",
            ...
            modelBuilder.Entity("ElectronicShop_Data.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateChanged = new DateTime(2023, 3, 24, 12, 37, 11, 752, DateTimeKind.Local).AddTicks(5943),
                            DateCreated = new DateTime(2023, 3, 24, 12, 37, 11, 752, DateTimeKind.Local).AddTicks(5934),
                            UserChanged = "admin"
                        },
                        new
                        {
                            ...
                            DateChanged = new DateTime(2023, 3, 24, 12, 37, 11, 752, DateTimeKind.Local).AddTicks(5946),
                            DateCreated = new DateTime(2023, 3, 24, 12, 37, 11, 752, DateTimeKind.Local).AddTicks(5946),
                            UserChanged = "admin"
                        },
                        new
                        {
                            ...
                            DateChanged = new DateTime(2023, 3, 24, 12, 37, 11, 752, DateTimeKind.Local).AddTicks(5948),
                            DateCreated = new DateTime(2023, 3, 24, 12, 37, 11, 752, DateTimeKind.Local).AddTicks(5948),
                            UserChanged = "admin"
                        });
                });
